[![Build Status](https://travis-ci.com/AlexMekkering/Home-Assistant-Configuration.svg?branch=master)](https://travis-ci.com/AlexMekkering/Home-Assistant-Configuration)
